  ...
  return (
    <div className="space-y-8 text-slate-400 leading-relaxed text-sm">
      <div className="space-y-2">
        <p className="font-bold text-white uppercase text-xs tracking-[0.2em] text-blue-500">Jr Core Systems • CNPJ: 65.089.647/0001-87</p>
      ...
      <section className="space-y-4">
        ...
        <p>Para questões legais ou solicitações de conformidade, entre em contato através do e-mail: <span className="text-blue-400 font-bold">jrcoresystems@gmail.com</span></p>
      </section>
    </div>
  );
};
